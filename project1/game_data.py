...
class Location:
    ...
    def __init__(self,location_coord, location_value, small_description, large_description, item) -> None:
...
class World:
    ...
    def load_location(self, location_data: TextIO) -> dict[str,list[str]]:
        """
        """
        dict1 = {}
    ...
    def load_item(self, item_data: TextIO): ->
        """
        """
...
def make_list(read_data)-> list[list[int]]:
    """ makes a list
    """
    k = []
    for i in read_data:
